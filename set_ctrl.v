...
localparam [2:0] LAST_MODE = ENABLE_ALARM ? SET_ALARM_MIN : SET_SEC;
...
assign alarm_hour_inc      = (ENABLE_ALARM && (mode_state == SET_ALARM_HOUR)) ? key_add : 1'b0;
assign alarm_hour_dec      = (ENABLE_ALARM && (mode_state == SET_ALARM_HOUR)) ? key_sub : 1'b0;
assign alarm_min_inc       = (ENABLE_ALARM && (mode_state == SET_ALARM_MIN))  ? key_add : 1'b0;
assign alarm_min_dec       = (ENABLE_ALARM && (mode_state == SET_ALARM_MIN))  ? key_sub : 1'b0;
assign alarm_enable_toggle = (ENABLE_ALARM && ((mode_state == RUN) || (mode_state == SET_ALARM_HOUR) || (mode_state == SET_ALARM_MIN))) ? key_rst : 1'b0;
